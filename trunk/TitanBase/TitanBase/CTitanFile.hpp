...
class CTitanFile
{
	private:
        ...
        */
		CFILE_CHAR*	ConvertBitFieldFileModeToASCIIFileMode( CFILE_SCHAR mode )
		{
			...
			{
				sprintf_s( (CFILE_CHAR*)result, 30, "%s, ccs=UNICODE", (CFILE_CHAR*)result );
				len += 13;
			}
			result[len] = 0x00;
			return result;
	...
	public:
        ...
        */
		CTitanFile( CFILE_CHAR* fname, CFILE_CHAR mode )
		{
			fh = NULL;
			ftype = FT_NONE;
			fmode = FM_NONE;	
        ...
        */
		CFILE_CHAR*	GetS( CTitanArray<CFILE_CHAR>* buf, CFILE_UINT max_count )
		{
			if( fh == NULL )
			{
				DoError( FE_NOFILEOPENED );
        ...
        */
		CFILE_CHAR*	ReadLn( )
		{
			...
			CTitanArray<CFILE_CHAR>* result = new CTitanArray<CFILE_CHAR>( CFILE_MAXLINELENGHT );
			result->Clean( );
        ...
        */
		CFILE_BOOLEAN PutS( CTitanArray<CFILE_CHAR>* str )
		{
			if( fh == NULL )
			{
				DoError( FE_NOFILEOPENED );
